...
(function(e) {
	...
	t.o = function() {
		...
		this.run = function() {
			...
			this.$div = e('<div style="' + (this.o.inline ? "display:inline;" : "") + "width:" + this.o
				.width + "px;height:" + this.o.height + "px;" + '"></div>');
			...
			this.scale = (window.devicePixelRatio || 1) / (this.c.webkitBackingStorePixelRatio || this.c
				.mozBackingStorePixelRatio || this.c.msBackingStorePixelRatio || this.c
		...
		this._carve = function() {
			if (this.relative) {
				var e = this.relativeWidth ? this.$div.parent().width() * parseInt(this.o.width) / 100 :
					this.$div.parent().width(),
					t = this.relativeHeight ? this.$div.parent().height() * parseInt(this.o.height) / 100 :
		...
		this._touch = function(e) {
			var r = function(e) {
				var t = n.xy2val(e.originalEvent.touches[n.t].pageX, e.originalEvent.touches[n.t]
				.pageY);
				if (t == n.cv) return;
		...
		this.h2rgba = function(e, t) {
			var n;
			e = e.substring(1, 7);
			n = [parseInt(e.substring(0, 2), 16), parseInt(e.substring(2, 4), 16), parseInt(e.substring(4,
				6), 16)];
	...
	t.Dial = function() {
		...
		this.listen = function() {
			var t = this,
				i, s, o = function(e) {
					...
					var o = e.originalEvent,
						...
						f = t._validate(t.o.parse(t.$.val())) + (u > 0 || a > 0 ? t.o.step : u < 0 || a <
							0 ? -t.o.step : 0);
			...
			this.$.bind("keydown", function(i) {
				...
				if (isNaN(u)) {
					s !== 13 && s !== 8 && s !== 9 && s !== 189 && (s !== 190 || t.$.val().match(
						/\./)) && i.preventDefault();
				...
				if (isNaN(u)) {
					...
					t.$.val() > t.o.max && t.$.val(t.o.max) || t.$.val() < t.o.min && t.$.val(t.o
						.min)
				}
			});
