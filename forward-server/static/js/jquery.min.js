/*! jQuery v2.2.0 | (c) jQuery Foundation | jquery.org/license */ ! function(a, b) {
	...
	function Fa(a, b, c) {
		...
		return c = c || Ca(a), c && (g = c.getPropertyValue(b) || c[b], "" !== g || n.contains(a.ownerDocument,
			a) || (g = n.style(a, b)), !l.pixelMarginRight() && Ba.test(g) && Aa.test(b) && (d = h.width, e = h
	...
	n.offset = {
		...
		position: function() {
			if (this[0]) {
				...
				.offset()), d.top += n.css(a[0], "borderTopWidth", !0) - a.scrollTop(), d.left += n
